...
function App() {
  return (
    <Router>
      <div className="min-h-screen bg-gray-700 p-5 flex flex-col items-center justify-center">
        <h1 className="text-3xl text-white font-bold text-center mt-9">Plataforma Citas Médica</h1>
        <nav className="flex justify-center space-x-4 mt-4">
          <button
            onClick={() => (window.location.href = "/registrar-paciente")}
            className="bg-cyan-800 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-300"
          >
            Registrar Paciente
          </button>
          <button
