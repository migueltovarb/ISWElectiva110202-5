...
<div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="w-full max-w-md p-8 rounded-xl shadow-none">
        <h2 className="text-4xl font-bold mb-2 text-center text-white">Iniciar Sesion Medico</h2>
        <p className="text-center text-white mb-8">Inicia sesión para acceder a tu cuenta Medica</p>
